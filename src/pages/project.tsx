...
function Project() {
    return (<div className="text-right">
        <div className="mt-5 p-5 leading-8">
            <h3 className="font-medium text-lg">شبیه ساز دیجی کالا</h3>
            <ul className="text-zinc-800 list-inside px-2 my-3">
                <li>Next.js و TypeScriptشبیه به فروشگاه دیجی کالا بااستفاده از</li>
                <li>برای ویدیومعرفی محصولstory کامپننت</li>
                <li>کامپننت سفارشی برای نمایش قیمت و تخفیف </li>
                <li>استفاده میکنهaxios که از login کامپننت </li>
